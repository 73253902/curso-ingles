...
function buildScript(bank, crossDayWords, dayNumber, theme, dayStory, dayJingle, dayStructures, dayAuxiliary){
  ...
  if(dayJingle && dayJingle.length){
    scr.push({ kind:'sequence', segs:jinglePreviewIntro, emoji:'🎵', words:dayJingle, isStory:true, isJingle:true, isPreview:true });
  }
  if(dayStory && dayStory.length){
    scr.push({ kind:'sequence', segs:storyPreviewIntro, emoji:'📖', words:dayStory, isStory:true, isDailyStory:true, isPreview:true });
  }
