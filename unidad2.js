  ...
  },
{
    ...
    songJingleLyrics:[
      ...
      {en:'It loves to eat lightning and drink liquid fire', es:'Le encanta comer rayos y beber fuego líquido', pron:'it lavs tu íit láitning and drink líquid fáier'},
      {en:'To fuel up its engine and take it much higher', es:'Para propulsar su motor y llevarlo mucho más alto', pron:'tu fiúel ap its ényin and téik it mach jáier'},
      {en:'Learning English is easy,', es:'Aprender inglés es fácil,', pron:'lérning ínglish is íisi,'},
      {en:'You\'re going to love it!', es:'¡Te va a encantar!', pron:'iór góing tu lav it!'},
      {en:'It can walk across oceans with giant steel feet', es:'Puede caminar por los océanos con gigantescos pies de acero', pron:'it can uók acrós óushans uid yáiant stíil fíit'},
      {en:'And drive a bright rocket right down the main street', es:'Y conducir un brillante cohete directo por la calle principal', pron:'and dráiv a bráit ráket ráit dáun de méin stríit'},
      {en:'It talks to the dolphins that swim in the blue', es:'Habla con los delfines que nadan en lo azul', pron:'it toks tu de dálfins dat suím in de blú'},
      {en:'It writes with sharp lasers to make something new', es:'Escribe con láseres filosos para hacer algo nuevo', pron:'it ráits uid sharp léisers tu méik sámzin niú'},
      {en:'It reads all the human minds like an open book', es:'Lee todas las mentes humanas como un libro abierto', pron:'it ríids ol de jiúman máinds láik an óupen buk'},
      {en:'And checks every secret with just one quick look', es:'Y revisa cada secreto con solo una mirada rápida', pron:'and cheks évri síicret uid yast uán cuík luk'},
      {en:'It sends secret messages out to the stars', es:'Envía mensajes secretos hacia las estrellas', pron:'it sends síicret méssiyis áut tu de stars'},
      {en:'And receives quick replies from the canyons of Mars', es:'Y recibe respuestas rápidas desde los cañones de Marte', pron:'and risíivs cuík ripláis fram de cányons of Mars'},
      {en:'It organizes a thousand planets in line', es:'Organiza mil planetas en línea', pron:'it órganáizis a záuzand plánets in láin'},
      {en:'And finishes tasks before stars cease to shine', es:'Y termina las tareas antes de que las estrellas dejen de brillar', pron:'and fínishis tasks bifór stars sis tu sháin'},
      {en:'Suddenly alarms start to echo around', es:'De repente las alarmas empiezan a resonar', pron:'sádenli alárms start tu écou aráund'},
      {en:'Something is broken and falling to ground', es:'Algo está roto y cayendo al suelo', pron:'sámzin is bróuken and fóling tu gráund'},
      {en:'It fixes it instantly right on the spot', es:'Lo arregla al instante justo en el lugar', pron:'it fíxis it instántli ráit on de spat'},
      {en:'And delivers the fix by a dragon\'s hot trot', es:'Y entrega el arreglo con el rápido trote caliente de un dragón', pron:'and dilívers de fix bái a drágons jat trat'},
      {en:'The mission is finished, the galaxy\'s saved', es:'La misión ha terminado, la galaxia está a salvo', pron:'de míshion is fínisht, de gálaxis séivd'},
      {en:'By the greatest machine that was ever engraved', es:'Por la máquina más grande que jamás haya sido grabada', pron:'bái de gréitest mashín dat uás éver ingréivd'},
      {en:'The story is over, the robot can rest', es:'La historia ha terminado, el robot puede descansar', pron:'de stóri is óuver, de róubat can rest'},
      {en:'With power and glory and passing the test', es:'Con poder y gloria y superando la prueba', pron:'uid páuer and glóri and pásing de test'},
      {en:'See you next week, dragon friend,', es:'Nos vemos la próxima semana, amigo dragón,', pron:'síi iú next uíik, drágon frend,'},
      {en:'Keep practicing until the end.', es:'Sigue practicando hasta el final.', pron:'kíip práctising antíl de end.'}
    ],
    songStoryLyrics:[
      {en:'The morning sun begins to rise', es:'El sol de la mañana empieza a salir', pron:'de mórning san biguíns tu ráis'},
      {en:'I have to walk out to my car', es:'Tengo que caminar hacia mi carro', pron:'ái jav tu uók áut tu mái car'},
      {en:'I have to drive to the warehouse door', es:'Tengo que conducir hasta la puerta del almacén', pron:'ái jav tu dráiv tu de uérjaus dor'},
      {en:'To start the busy shift afar', es:'Para empezar el turno ajetreado', pron:'tu start de bísi shift afár'},
      {en:'I have to eat and I have to drink', es:'Tengo que comer y tengo que beber', pron:'ái jav tu íit and ái jav tu drink'},
      {en:'To keep my energy on the brink', es:'Para mantener mi energía al límite', pron:'tu kíip mái énerchi on de brink'},
      {en:'I have to talk with all my men', es:'Tengo que hablar con todos mis hombres', pron:'ái jav tu tok uid ol mái men'},
      {en:'I have to write the orders down', es:'Tengo que anotar los pedidos', pron:'ái jav tu ráit de órders dáun'},
      {en:'I have to read the new demands', es:'Tengo que leer las nuevas demandas', pron:'ái jav tu ríid de niú dimánds'},
      {en:'That come from dealers in the town', es:'Que vienen de los distribuidores del pueblo', pron:'dat cam fram díilers in de táun'},
      {en:'I have to send the quotes away', es:'Tengo que enviar las cotizaciones', pron:'ái jav tu send de cuóuts auéi'},
      {en:'I have to receive the heavy truck', es:'Tengo que recibir el camión pesado', pron:'ái jav tu risíiv de jévi trak'},
      {en:'I have to call the client back', es:'Tengo que devolverle la llamada al cliente', pron:'ái jav tu col de cláient bak'},
      {en:'To test our business and our luck', es:'Para poner a prueba nuestro negocio y nuestra suerte', pron:'tu test áur bísnes and áur lak'},
      {en:'I have to organize the stock', es:'Tengo que organizar el inventario', pron:'ái jav tu órganáiz de stak'},
      {en:'I have to check the steel and screws', es:'Tengo que revisar el acero y los tornillos', pron:'ái jav tu chek de stíil and scrus'},
      {en:'I have to finish every task', es:'Tengo que terminar cada tarea', pron:'ái jav tu fínish évri task'},
      {en:'Before I share the brilliant news', es:'Antes de compartir la gran noticia', pron:'bifór ái sher de brílient niús'},
      {en:'I have to fix what went astray', es:'Tengo que arreglar lo que salió mal', pron:'ái jav tu fix uát uént astréi'},
      {en:'I have to deliver and save the day', es:'Tengo que entregar y salvar el día', pron:'ái jav tu dilíver and séiv de déi'},
      {en:'Every word is part of the road', es:'Cada palabra es parte del camino', pron:'évri uord is part of de róud'},
      {en:'Building the future, stone by stone', es:'Construyendo el futuro, piedra por piedra', pron:'bílding de fiúchur, stóun bái stóun'}
    ],
    words:[
  ...
  },
{
    ...
    songStoryLyrics:[
      {en:'Step into the sky, where the islands float and dream.', es:'Da el paso hacia el cielo, donde las islas flotan y sueñan.', pron:'step íntu de skái, uér de áilands flóut and dríim.'},
      {en:'High in the clouds where the islands float free,', es:'Lo alto en las nubes donde las islas flotan libres,', pron:'jái in de cláuds uér de áilands flóut fríi,'},
      {en:'The Great Architect works where no one can see.', es:'El Gran Arquitecto trabaja donde nadie puede ver.', pron:'de gréit árquitect uorks uér nóu uán can síi.'},
      {en:'I have to use the hammer to anchor the sky.', es:'Tengo que usar el martillo para anclar el cielo.', pron:'ái jav tu iús de jámer tu ánker de skái.'},
      {en:'The wind begins spinning and turning the gears,', es:'El viento comienza a girar y a mover los engranajes,', pron:'de uínd biguíns spíning and térning de guíars,'},
      {en:'I have to find the screwdriver in the great hall.', es:'Tengo que encontrar el desarmador en el gran salón.', pron:'ái jav tu fáind de scrúdráiver in de gréit jol.'},
      {en:'Learning English is easy!', es:'¡Aprender inglés es fácil!', pron:'lérning ínglish is íisi!'},
      {en:'You\'re going to love it!', es:'¡Te va a encantar!', pron:'iór góing tu lav it!'},
      {en:'He reaches the clouds and he starts to ascend,', es:'Él llega a las nubes y comienza a ascender,', pron:'ji ríichis de cláuds and ji starts tu asénd,'},
      {en:'I have to climb the ladder to reach the high shelf.', es:'Tengo que subir la escalera para alcanzar el estante alto.', pron:'ái jav tu cláim de láder tu ríich de jái shelf.'},
      {en:'He flies to the store in the blink of an eye,', es:'Él vuela a la tienda en un abrir y cerrar de ojos,', pron:'ji fláis tu de stor in de blink of an ái,'},
      {en:'I have to buy the paint to color the sky.', es:'Tengo que comprar la pintura para colorear el cielo.', pron:'ái jav tu bái de péint tu cálor de skái.'},
      {en:'Learning English is easy!', es:'¡Aprender inglés es fácil!', pron:'lérning ínglish is íisi!'},
      {en:'You\'re going to love it!', es:'¡Te va a encantar!', pron:'iór góing tu lav it!'},
      {en:'A scroll of the stars that he needs to command,', es:'Un pergamino de las estrellas que necesita comandar,', pron:'a scróul of de stars dat ji níids tu camánd,'},
      {en:'I have to grab the pen and write with my hand.', es:'Tengo que agarrar el lapicero y escribir con mi mano.', pron:'ái jav tu grab de pen and ráit uid mái jand.'},
      {en:'The gravity maps are all scattered and wide,', es:'Los mapas de gravedad están todos dispersos y amplios,', pron:'de grávati maps ar ol skátered and uáid,'},
      {en:'I have to use the stapler right then and there.', es:'Tengo que usar la grapadora justo ahí y en ese momento.', pron:'ái jav tu iús de stéipler ráit den and der.'},
      {en:'I don\'t have to use the broom, the stars do not weep,', es:'No tengo que usar la escoba, las estrellas no lloran,', pron:'ái dont jav tu iús de brum, de stars du nat uíip,'},
      {en:'I have to organize the folders before they all sleep.', es:'Tengo que organizar las carpetas antes de que todas duerman.', pron:'ái jav tu órganáiz de fóulders bifór déi ol slíip.'},
      {en:'The islands are steady, the sky is all bright,', es:'Las islas están firmes, el cielo está brillante,', pron:'de áilands ar stédi, de skái is ol bráit,'},
      {en:'He whispers to a dragon, a friend so grand:', es:'Él le susurra a un dragón, un amigo muy grande:', pron:'ji uíspers tu a drágon, a frend sóu grand:'},
      {en:'See you next week, G-Dragon friend.', es:'Nos vemos la próxima semana, amigo G-Dragon.', pron:'síi iú next uíik, yí-drágon frend.'},
      {en:'Keep practicing until the end.', es:'Sigue practicando hasta el final.', pron:'kíip práctising antíl de end.'}
    ],
    words:[
  ...
  },
{
    ...
    songJingleLyrics:[
      ...
      {en:'I have a cat big as a horse, what a sight!', es:'Tengo un gato tan grande como un caballo, qué espectáculo!', pron:'ái jav a cat big as a jors, uát a sáit!'},
      {en:'I have a bird that breathes ice in the air,', es:'Tengo un pájaro que respira hielo en el aire,', pron:'ái jav a berd dat bríizs áis in de er,'},
      {en:'I feed them cotton candy with love and care.', es:'Les doy de comer algodón de azúcar con amor y cuidado.', pron:'ái fíid dem cáton kándi uid lav and ker.'},
      {en:'Learning English is easy,', es:'Aprender inglés es fácil,', pron:'lérning ínglish is íisi,'},
      {en:'You\'re going to love it!', es:'¡Te va a encantar!', pron:'iór góing tu lav it!'},
      {en:'Our values are honesty, respect, and teamwork,', es:'Nuestros valores son honestidad, respeto y trabajo en equipo,', pron:'áur váliuus ar ánesti, rispéct, and tíimuork,'},
      {en:'Even for dragons and robots in this work!', es:'Incluso para dragones y robots en este trabajo!', pron:'íven for drágons and róubats in dis uork!'},
      {en:'Our mission is to save the kingdoms today,', es:'Nuestra misión es salvar los reinos hoy,', pron:'áur míshion is tu séiv de kíngdams tudéi,'},
      {en:'Our vision is trust and growth, lead the way!', es:'Nuestra visión es confianza y crecimiento, lidera el camino!', pron:'áur víshion is trast and gróuz, líid de uéi!'},
      {en:'He has a dragon, he feeds it a cloud,', es:'Él tiene un dragón, le da de comer una nube,', pron:'ji jas a drágon, ji fíids it a cláud,'},
      {en:'She has a giant cat, purring so loud,', es:'Ella tiene un gato gigante, ronroneando tan fuerte,', pron:'shi jas a yáiant cat, péring sóu láud,'},
      {en:'They have a bird of ice, strong and grand,', es:'Ellos tienen un pájaro de hielo, fuerte y grandioso,', pron:'déi jav a berd of áis, strong and grand,'},
      {en:'We feed the whole team, across the land.', es:'Alimentamos a todo el equipo, a través de la tierra.', pron:'uí fíid de jóul tíim, acrós de land.'},
      {en:'Commitment is our superpower, we shine,', es:'El compromiso es nuestro superpoder, brillamos!', pron:'camítment is áur súperpáuer, uí sháin,'},
      {en:'We grow together, in line with the design,', es:'Crecemos juntos, en línea con el diseño,', pron:'uí gróu tugéder, in láin uid de disáin,'},
      {en:'Trust in the mission, trust in the dream,', es:'Confía en la misión, confía en el sueño,', pron:'trast in de míshion, trast in de dríim,'},
      {en:'We are the best fantasy team!', es:'Somos el mejor equipo de fantasía!', pron:'uí ar de best fántasi tíim!'},
      {en:'Learning English is easy,', es:'Aprender inglés es fácil,', pron:'lérning ínglish is íisi,'},
      {en:'You\'re going to love it!', es:'¡Te va a encantar!', pron:'iór góing tu lav it!'},
      {en:'Our values are honesty, respect, and teamwork,', es:'Nuestros valores son honestidad, respeto y trabajo en equipo,', pron:'áur váliuus ar ánesti, rispéct, and tíimuork,'},
      {en:'Even for dragons and robots in this work!', es:'Incluso para dragones y robots en este trabajo!', pron:'íven for drágons and róubats in dis uork!'},
    ...
    songStoryLyrics:[
      {en:'Welcome to the core. A new shift begins today. Let\'s make it count.', es:'Bienvenidos al núcleo. Hoy comienza una nueva etapa. Hagamos que cuente.', pron:'uélcam tu de cor. a niú shift bigíns tudéi. lets méik it cáunt.'},
      {en:'At the station doors, the morning light is breaking,', es:'A la puerta de la base, la mañana está brillando,', pron:'at de stéishion dors, de mórning láit is bréiking,'},
      {en:'My pet is a baby dragon, wide awake and shaking!', es:'Mi mascota es un dragón bebé, bien despierto y temblando!', pron:'mái pet is a béibi drágon, uáid auéik and shéiking!'},
      {en:'I walk past the stables where the creatures roam and play,', es:'Y paso junto a los establos donde juegan sin parar,', pron:'ái uók past de stéibols uér de críichurs róum and pléi,'},
      {en:'I have a cat big as a horse, blocking up the way.', es:'Tengo un gato tan grande como un caballo, que no me deja pasar.', pron:'ái jav a cat big as a jors, blóking ap de uéi.'},
      {en:'And right above the hangar, in the cold and frozen skies,', es:'Y justo sobre el hangar, en los cielos fríos y de hielo,', pron:'and ráit abáv de jángar, in de cóuld and fróuzen skáis,'},
      {en:'I have a bird that breathes ice, soaring high and wise.', es:'Tengo un pájaro que respira hielo, volando alto sin velo.', pron:'ái jav a berd dat bríizs áis, sóring jái and uáis.'},
      {en:'Every morning, before the tasks are through,', es:'Cada mañana, antes de empezar la labor,', pron:'évri mórning, bifór de tasks ar zru,'},
      {en:'I feed them clouds of cotton candy, sweet and pink and blue!', es:'Les doy nubes de algodón de azúcar de sabor y color!', pron:'ái fíid dem cláuds of cáton kándi, suít and pink and blú!'},
      {en:'Learning English is easy,', es:'Aprender inglés es fácil,', pron:'lérning ínglish is íisi,'},
      {en:'you\'re going to love it!', es:'te va a encantar!', pron:'iór góing tu lav it!'},
      {en:'Our company values keep us standing tall,', es:'Los valores de nuestra empresa nos mantienen de pie!', pron:'áur cámpani váliuus kíip as stánding tol,'},
      {en:'Honesty and respect are for one and all!', es:'Honestidad y respeto para todos a la vez!', pron:'ánesti and rispéct ar for uán and ol!'},
      {en:'Teamwork is the engine that drives us through the dark,', es:'El trabajo en equipo es el motor que nos da luz,', pron:'tíimuork is de ényin dat dráivs as zru de dark,'},
      {en:'Even between dragons and robots leaving a spark!', es:'Incluso entre dragones y robots con gran virtud!', pron:'íven bituíin drágons and róubats líiving a spark!'},
      {en:'He has a tiny dragon resting on his knee,', es:'Él tiene un dragón pequeño descansando en su rodilla,', pron:'ji jas a táini drágon résting on jis níi,'},
      {en:'She has a giant cat purring by the sea.', es:'Ella tiene un gato gigante roncando en la orilla.', pron:'shi jas a yáiant cat péring bái de síi.'},
      {en:'They have a frozen bird keeping watch above,', es:'Ellos tienen un ave helada cuidando desde el cielo,', pron:'déi jav a fróuzen berd kíiping uách abáv,'},
      {en:'And we have a mission driven by our love.', es:'Y nosotros tenemos una misión guiada por anhelo.', pron:'and uí jav a míshion dríven bái áur lav.'},
      {en:'Our vision is a universe of trust and endless growth,', es:'Nuestra visión es un universo de confianza y crecimiento,', pron:'áur víshion is a iúnivers of trast and éndles gróuz,'},
      {en:'Where every single citizen is thriving and robust.', es:'Donde cada ciudadano avanza firme en el momento.', pron:'uér évri síngol sítizen is zráiving and róubast.'},
      {en:'Commitment is our superpower, burning bright and deep,', es:'El compromiso es nuestro superpoder, brillando con valor!', pron:'camítment is áur súperpáuer, bérning bráit and díip,'},
      {en:'We keep every promise that we swore to keep!', es:'Cumplimos cada promesa con lealtad y amor!', pron:'uí kíip évri prámis dat uí suór tu kíip!'},
      {en:'Learning English is easy,', es:'Aprender inglés es fácil,', pron:'lérning ínglish is íisi,'},
      {en:'you\'re going to love it!', es:'te va a encantar!', pron:'iór góing tu lav it!'},
      {en:'Our company values keep us standing tall,', es:'Los valores de nuestra empresa nos mantienen de pie!', pron:'áur cámpani váliuus kíip as stánding tol,'},
      {en:'Honesty and respect are for one and all!', es:'Honestidad y respeto para todos a la vez!', pron:'ánesti and rispéct ar for uán and ol!'},
      {en:'Teamwork is the engine that drives us through the dark,', es:'El trabajo en equipo es el motor que nos da luz,', pron:'tíimuork is de ényin dat dráivs as zru de dark,'},
      {en:'Even between dragons and robots leaving a spark!', es:'Incluso entre dragones y robots con gran virtud!', pron:'íven bituíin drágons and róubats líiving a spark!'},
      {en:'Keep your values close and let your actions fit.', es:'Mantén tus valores cerca y hazlos destacar.', pron:'kíip iór váliuus clóus and let iór ákshions fit.'},
      {en:'This is the station signing off, my friend.', es:'Aquí se despide la estación, amigo.', pron:'dis is de stéishion sáining of, mái frend.'},
      {en:'See you on the next mission, faithful dragon!', es:'Nos vemos en la próxima misión, fiel dragón!', pron:'síi iú on de next míshion, féizful drágon!'}
    ],
    words:[
  ...
  },
{
    ...
    songJingleLyrics:[
      ...
      {en:'He lives up on the mountain range,', es:'Vive arriba en la montaña,', pron:'ji livs ap on de máuntan réinch,'},
      {en:'Our neighborhood is a community,', es:'Nuestro barrio, comunidad,', pron:'áur néiborjud is a camiúniti,'},
      {en:'A welcoming and vibrant place.', es:'Un lugar que da confianza.', pron:'a uélcaming and váibrant pléis.'},
      {en:'Learning English is easy,', es:'Aprender inglés es fácil,', pron:'lérning ínglish is íisi,'},
      {en:'You\'re going to love it!', es:'¡Te va a encantar!', pron:'iór góing tu lav it!'},
      {en:'I recommend our service now,', es:'Recomiendo nuestro servicio,', pron:'ái récomend áur sérvis náu,'},
      {en:'She always recommends us too,', es:'Ella nos recomienda así,', pron:'shi ólueis récomends as tu,'},
      {en:'Her feedback helps us grow and learn,', es:'Su feedback nos hace crecer,', pron:'jer fíidbak jelps as gróu and lern,'},
      {en:'Our long-term relationship is true.', es:'Nuestra relación es real.', pron:'áur long-term riléishionship is trú.'},
      {en:'We have a loyal customer,', es:'Tenemos una clienta fiel,', pron:'uí jav a lóial cástomer,'},
      {en:'A turtle, wise and ancient too,', es:'Una tortuga de mil años,', pron:'a tértol, uáis and éincient tu,'},
      {en:'She always comes right back to us,', es:'Ella siempre vuelve aquí,', pron:'shi ólueis cams ráit bak tu as,'},
      {en:'Her trust in us is honest and true.', es:'Su confianza no hace daño.', pron:'jer trast in as is ánest and trú.'},
      {en:'I recommend our service now,', es:'Recomiendo nuestro servicio,', pron:'ái récomend áur sérvis náu,'},
      {en:'She always recommends us too,', es:'Ella nos recomienda así,', pron:'shi ólueis récomends as tu,'},
      {en:'Her feedback helps us grow and learn,', es:'Su feedback nos hace crecer,', pron:'jer fíidbak jelps as gróu and lern,'},
      {en:'Our long-term relationship is true.', es:'Nuestra relación es real.', pron:'áur long-term riléishionship is trú.'},
      {en:'Her loyalty, a guiding light,', es:'Su lealtad brilla fuerte,', pron:'jer lóialti, a gáiding láit,'},
      {en:'She helps us see what\'s fair and right,', es:'Nos ayuda a ver lo justo,', pron:'shi jelps as síi uáts fer and ráit,'},
      {en:'We learn from her advice each day,', es:'Aprendemos de su saber,', pron:'uí lern fram jer adváis íich déi,'},
      {en:'And she guides us on our way.', es:'Y guía nuestro camino.', pron:'and shi gáids as on áur uéi.'},
      {en:'If there\'s ever a complaint,', es:'Si hay alguna queja,', pron:'if ders éver a campléint,'},
      {en:'A dragon finds a way to solve,', es:'Un dragón halla solución,', pron:'a drágon fáinds a uéi tu salv,'},
      {en:'They fix it fast, without delay,', es:'La arreglan sin demora,', pron:'déi fix it fast, uidáut diléi,'},
      {en:'Every problem, they resolve.', es:'Todo problema resuelve.', pron:'évri práblem, déi rizálv.'},
      {en:'Learning English is easy,', es:'Aprender inglés es fácil,', pron:'lérning ínglish is íisi,'},
      {en:'You\'re going to love it!', es:'¡Te va a encantar!', pron:'iór góing tu lav it!'},
      {en:'See you next week, dragon friend,', es:'Nos vemos la próxima semana, amigo dragón,', pron:'síi iú next uíik, drágon frend,'},
      {en:'Keep practicing until the end.', es:'Sigue practicando hasta el final.', pron:'kíip práctising antíl de end.'}
    ...
    songStoryLyrics:[
      {en:'Ooh, let\'s learn together now.', es:'Ooh, aprendamos juntos ahora', pron:'úu, lets lern tugéder náu.'},
      {en:'My neighbor is a friendly soul,', es:'Mi vecino es un alma fiel.', pron:'mái néibor is a fréndli sóul,'},
      {en:'He lives on mountains, calm and whole,', es:'Vive en montes, con nivel.', pron:'ji livs on máuntans, calm and jóul,'},
      {en:'Our neighborhood is community,', es:'La comunidad es nuestra unión,', pron:'áur néiborjud is camiúniti,'},
      {en:'With robots and wizards, wild and free.', es:'Magos y robots, de corazón.', pron:'uid róubats and uízards, uáild and fríi.'},
      {en:'Learning English is easy,', es:'Aprender inglés es fácil,', pron:'lérning ínglish is íisi,'},
      {en:'You\'re going to love it!', es:'¡Te va a encantar!', pron:'iór góing tu lav it!'},
      {en:'I recommend our service now,', es:'Recomiendo el servicio hoy.', pron:'ái récomend áur sérvis náu,'},
      {en:'I recommend the how and wow,', es:'Recomiendo a donde voy.', pron:'ái récomend de jáu and uáu,'},
      {en:'I recommend a solution grand,', es:'Recomiendo solución genial,', pron:'ái récomend a solúshion grand,'},
      {en:'I recommend the best in land.', es:'Recomiendo lo mejor, total.', pron:'ái récomend de best in land.'},
      {en:'A loyal customer is here,', es:'Un cliente fiel siempre estará.', pron:'a lóial cástomer is jíar,'},
      {en:'She comes back around every year,', es:'Cada año volverá!', pron:'shi cams bak aráund évri íar,'},
      {en:'She is reliable and true,', es:'Es confiable, de verdad,', pron:'shi is riláiabol and trú,'},
      {en:'She gives us feedback, good and new.', es:'Da comentarios, con lealtad.', pron:'shi guivs as fíidbak, gud and niú.'},
      {en:'If any complaint comes to view,', es:'Si una queja viene hoy aquí,', pron:'if éni campléint cams tu viú,'},
      {en:'A dragon brings a solution true,', es:'Dragón trae solución para ti.', pron:'a drágon brings a solúshion trú,'},
      {en:'With loyalty in every space,', es:'Con lealtad en cada rincón,', pron:'uid lóialti in évri spéis,'},
      {en:'We lead the way with happy grace.', es:'Lideramos con mucha ilusión.', pron:'uí líid de uéi uid jápi gréis.'},
      {en:'I recommend our service now,', es:'Recomiendo el servicio hoy.', pron:'ái récomend áur sérvis náu,'},
      {en:'I recommend the how and wow,', es:'Recomiendo a donde voy.', pron:'ái récomend de jáu and uáu,'},
      {en:'I recommend a solution grand,', es:'Recomiendo solución genial,', pron:'ái récomend a solúshion grand,'},
      {en:'I recommend the best in land.', es:'Recomiendo lo mejor, total.', pron:'ái récomend de best in land.'},
      {en:'I recommend a referral too,', es:'Recomiendo un referido así.', pron:'ái récomend a riférral tu,'},
      {en:'Long-term relationship is due,', es:'Relación larga que está aquí.', pron:'long-term riléishionship is diú,'},
      {en:'See you next week, dragon friend,', es:'Nos vemos la próxima semana, amigo dragón,', pron:'síi iú next uíik, drágon frend,'},
      {en:'Keep practicing until the end.', es:'Sigue practicando hasta el final.', pron:'kíip práctising antíl de end.'}
    ],
    words:[
  ...
  },
{
    ...
    songJingleLyrics:[
      ...
      {en:'Actually, it feels just like a realm of ancient dreams.', es:'En realidad, se siente como un reino de viejos sueños.', pron:'ákchuali, it fíils yast láik a relm of éincient dríims.'},
      {en:'For example, in general, dragons fly so slow,', es:'Por ejemplo, en general, los dragones vuelan muy lento,', pron:'for exámpol, in yéneral, drágons flái sóu slóu,'},
      {en:'As usual, they follow where the cosmic currents flow.', es:'Como siempre, siguen las corrientes del cosmos.', pron:'as iúshual, déi fálou uér de cásmic cárrents flóu.'},
      {en:'Learning English is easy,', es:'Aprender inglés es fácil,', pron:'lérning ínglish is íisi,'},
      {en:'you\'re going to love it!', es:'¡te va a encantar!', pron:'iór góing tu lav it!'},
      {en:'We are almost there, but still the shadows fall,', es:'Ya casi llegamos, pero las sombras todavía caen,', pron:'uí ar ólmoust der, bat stil de shádous fol,'},
      {en:'Already the silence is echoing our call.', es:'El silencio ya está haciendo eco de nuestro llamado.', pron:'olrédi de sáilens is écouing áur col.'},
      {en:'By the way, my heart has finally found its home,', es:'A propósito, mi corazón al fin ha hallado su hogar,', pron:'bái de uéi, mái jart jas fáinali fáund its jóum,'},
      {en:'No matter how far through the galaxy we roam.', es:'Sin importar qué tan lejos vagamos en la galaxia.', pron:'nóu máter jáu far zru de gálaxi uí róum.'},
      {en:'Don\'t worry, it\'s fine, there is no need to run,', es:'No te preocupes, está bien, no hay necesidad de huir,', pron:'dont uóri, its fáin, der is nóu níid tu ran,'},
      {en:'No rush, take your time underneath this fading sun.', es:'Sin prisa, tómate tu tiempo bajo este sol que se apaga.', pron:'nóu rash, téik iór táim ánderníiz dis féiding san.'},
      {en:'Actually, the journey is better when it\'s shared,', es:'En realidad, el viaje es mejor cuando se comparte,', pron:'ákchuali, de yérni is béter uén its shérd,'},
      {en:'For example, look how much we both have dared.', es:'Por ejemplo, mira cuánto nos hemos atrevido.', pron:'for exámpol, luk jáu mach uí bóuz jav dérd.'},
      {en:'Still the universe is spinning round and round,', es:'El universo todavía sigue girando sin cesar,', pron:'stil de iúnivers is spíning ráund and ráund,'},
      {en:'Already a brand new destiny is found.', es:'Un destino totalmente nuevo ya se ha encontrado.', pron:'olrédi a brand niú déstini is fáund.'},
      {en:'As usual, don\'t worry, we\'re stronger than the pain,', es:'Como siempre, no te preocupes, somos más fuertes que el dolor,', pron:'as iúshual, dont uóri, uír strónguer dan de péin,'},
      {en:'Taking our time to wash away the rain.', es:'Tomándonos nuestro tiempo para limpiar la tempestad.', pron:'téiking áur táim tu uásh auéi de réin.'},
      {en:'Learning English is easy,', es:'Aprender inglés es fácil,', pron:'lérning ínglish is íisi,'},
      {en:'you\'re going to love it!', es:'¡te va a encantar!', pron:'iór góing tu lav it!'},
      {en:'We are almost there, but still the shadows fall,', es:'Ya casi llegamos, pero las sombras todavía caen,', pron:'uí ar ólmoust der, bat stil de shádous fol,'},
      {en:'Already the silence is echoing our call.', es:'El silencio ya está haciendo eco de nuestro llamado.', pron:'olrédi de sáilens is écouing áur col.'},
    ...
    songStoryLyrics:[
      {en:'Stand by the cockpit window. The starlight is waiting.', es:'Prepárate junto a la ventana de la cabina. La luz de las estrellas está esperando.', pron:'stand bái de cákpit uíndou. de stárláit is uéiting.'},
      {en:'By the way, have you seen the rings of Saturn shine today?', es:'A propósito, ¿has visto los anillos de Saturno brillar hoy?', pron:'bái de uéi, jav iú síin de rings of sáturn sháin tudéi?'},
      {en:'Actually, they whisper secrets as we drift away.', es:'En realidad, susurran secretos mientras nos alejamos.', pron:'ákchuali, déi uísper síicrets as uí drift auéi.'},
      {en:'For example, comets choose their own path in flight,', es:'Por ejemplo, los cometas eligen su propio camino de vuelo,', pron:'for exámpol, cámets chúus der óun paz in fláit,'},
      {en:'As usual, the nebula paints the sky with silver light.', es:'Como siempre, la nebulosa pinta el cielo con luz de plata.', pron:'as iúshual, de nébiula péints de skái uid sílver láit.'},
      {en:'Learning English is easy,', es:'Aprender inglés es fácil,', pron:'lérning ínglish is íisi,'},
      {en:'you\'re going to love it!', es:'¡te va a encantar!', pron:'iór góing tu lav it!'},
      {en:'We are almost there, but still the engines hum,', es:'Ya casi llegamos, pero los motores aún zumban,', pron:'uí ar ólmoust der, bat stil de ényins jam,'},
      {en:'Already the future calls us, and the moment\'s come.', es:'Ya el futuro nos llama, y el momento ha llegado.', pron:'olrédi de fiúchur cols as, and de móuments cam.'},
      {en:'By the way, the cosmos opens up a friendly door,', es:'A propósito, el cosmos abre una puerta amiga,', pron:'bái de uéi, de cásmos óupens ap a fréndli dor,'},
      {en:'Where time and space can hurt us nevermore.', es:'Donde el tiempo y el espacio ya no pueden herirnos.', pron:'uér táim and spéis can jert as névermor.'},
      {en:'Don\'t worry, it\'s fine, the galaxy is wide and deep,', es:'No te preocupes, está bien, la galaxia es amplia y profunda,', pron:'dont uóri, its fáin, de gálaxi is uáid and díip,'},
      {en:'No rush, take your time while the sleeping planets sleep.', es:'Sin prisa, tómate tu tiempo mientras los planetas duermen.', pron:'nóu rash, téik iór táim uáil de slíiping plánets slíip.'},
      {en:'Actually, every journey has a purpose of its own,', es:'En realidad, cada viaje tiene un propósito propio,', pron:'ákchuali, évri yérni jas a pérpos of its óun,'},
      {en:'For example, look at how much our souls have grown.', es:'Por ejemplo, mira cuánto han crecido nuestras almas.', pron:'for exámpol, luk at jáu mach áur sóuls jav gróun.'},
      {en:'Still the stardust gathers in a spiral dance,', es:'El polvo estelar todavía se reúne en una danza en espiral,', pron:'stil de stárdast gáders in a spáiral dans,'},
      {en:'Already we are caught within a grand romance.', es:'Ya estamos atrapados en un gran romance.', pron:'olrédi uí ar cot uidín a grand románs.'},
      {en:'As usual, don\'t worry, we are safe within the night,', es:'Como siempre, no te preocupes, estamos a salvo en la noche,', pron:'as iúshual, dont uóri, uí ar séif uidín de náit,'},
      {en:'Taking our time to find the guiding light.', es:'Tomándonos nuestro tiempo para hallar la luz guía.', pron:'téiking áur táim tu fáind de gáiding láit.'},
      {en:'Learning English is easy,', es:'Aprender inglés es fácil,', pron:'lérning ínglish is íisi,'},
      {en:'you\'re going to love it!', es:'¡te va a encantar!', pron:'iór góing tu lav it!'},
      {en:'We are almost there, but still the engines hum,', es:'Ya casi llegamos, pero los motores aún zumban,', pron:'uí ar ólmoust der, bat stil de ényins jam,'},
      {en:'Already the future calls us, and the moment\'s come.', es:'Ya el futuro nos llama, y el momento ha llegado.', pron:'olrédi de fiúchur cols as, and de móuments cam.'},
