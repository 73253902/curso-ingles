...
const curriculumUnidad3 = [
{
    ...
    songJingle:'cancion-dia25-vocabulario.mp3',
    songStory:'cancion-dia25-historia.mp3',
    songJingleLyrics:[
      {en:'Numbers and vocabulary is easy day.', es:'Números y vocabulario son fáciles hoy', pron:'námbers and vocábiuleri is íisi déi.'},
      {en:'Eleven es once, twelve es doce hoy,', es:'Eleven significa once, twelve significa doce hoy,', pron:'iléven es once, tuélv es doce hoy,'},
      {en:'Thirteen trece, fourteen catorce donde voy.', es:'Thirteen es trece, fourteen es catorce, donde voy.', pron:'zértiin trece, fórtiin catorce donde voy.'},
      {en:'Fifteen quince, sixteen dieciséis,', es:'Fifteen es quince, sixteen es dieciséis,', pron:'fíftiin quince, síkstiin dieciséis,'},
      {en:'Seventeen diecisiete,', es:'Seventeen es diecisiete,', pron:'séventiin diecisiete,'},
      {en:'eighteen dieciocho tu aprederas.', es:'eighteen es dieciocho, tú lo aprenderás.', pron:'éitiin dieciocho tu aprenderás.'},
      ...
      {en:'It costs approximately fifty dollars,', es:'Cuesta aproximadamente cincuenta dólares', pron:'it costs aprácsimetli fífti dólars,'},
      {en:'It costs a lot,', es:'Cuesta mucho.', pron:'it costs a lot,'},
      {en:'It costs twenty dollars,', es:'Cuesta veinte dólares.', pron:'it costs tuénti dólars,'},
      {en:'That one is much better', es:'Ese es mucho mejor', pron:'dat uán is mach béter'},
      {en:'Nineteen diecinueve, twenty veinte ya,', es:'Nineteen es diecinueve, twenty es veinte ya,', pron:'náintiin diecinueve, tuénti veinte ya,'},
      {en:'Budget es presupuesto que calculará.', es:'Budget significa presupuesto, que calculará.', pron:'báyet es presupuesto que calculará.'},
      {en:'To cost es el costo, Cheap es barato,', es:'To cost significa el costo, cheap significa barato,', pron:'tu cost es el costo, chíip es barato,'},
      {en:'expensive es costoso, huy que caro.', es:'expensive significa costoso, huy qué caro.', pron:'ekspénsiv es costoso, huy que caro.'},
      {en:'Approximately es aproximadamente,', es:'Approximately significa aproximadamente,', pron:'aprácsimetli es aproximadamente,'},
      {en:'Final price es el precio final del presente.', es:'Final price significa el precio final, del presente.', pron:'fáinal práis es el precio final del presente.'},
    ...
    songStoryLyrics:[
      {en:'In the shadow of the gloom market,', es:'En la penumbra del mercado de sombras,', pron:'in de sháaou of de glúum márket,'},
      {en:'We must count the relics before night falls...', es:'debemos contar las reliquias antes de que caiga la noche...', pron:'uí mast cáunt de rélics bifór náit fols...'},
      {en:'Eleven, twelve, thirteen, fourteen, fifteen, sixteen, seventeen, eighteen, nineteen, twenty,', es:'Once, doce, trece, catorce, quince, dieciséis, diecisiete, dieciocho, diecinueve, veinte,', pron:'iléven, tuélv, zértiin, fórtiin, fíftiin, síkstiin, séventiin, éitiin, náintiin, tuénti,'},
      {en:'The guardian checks the budget,', es:'El guardián consulta el presupuesto de la expedición...', pron:'de gárdian cheks de báyet,'},
      {en:'Does he know the cost?', es:'¿Sabe su costo?', pron:'das ji nóu de cost?'},
      {en:'An object can be expensive or cheap...', es:'un objeto puede ser costoso, o barato.', pron:'an ábyekt can bi ekspénsiv or chíip...'},
      {en:'He calculates approximately to set the final price.', es:'Calcula aproximadamente para fijar el precio final.', pron:'ji cálkiuleits aprácsimetli tu set de fáinal práis.'},
      {en:'The map reveals the secrets of the Kingdom:', es:'El mapa revela los secretos del Reino:', pron:'de map riviíls de síicrets of de kíngdam:'},
      {en:'The dragon market has eleven floating shops,', es:'El mercado del dragón tiene once tiendas flotantes,', pron:'de drágon márket jas iléven flóuting shops,'},
      {en:'twelve flying carts, and thirteen giant coin piles!', es:'doce carritos voladores, ¡y trece pilas gigantes de monedas!', pron:'tuélv fláing carts, and zértiin yáiant cóin páils!'},
      {en:'Our budget today is fourteen mountains of gold,', es:'Nuestro presupuesto de hoy es catorce montañas de oro,', pron:'áur báyet tudéi is fórtiin máuntans of góuld,'},
      {en:'fifteen rivers of silver,', es:'quince ríos de plata,', pron:'fíftiin rívers of sílver,'},
      {en:'and sixteen, seventeen, eighteen, nineteen, twenty treasure chests!', es:'y dieciséis, diecisiete, dieciocho, diecinueve, veinte cofres del tesoro!', pron:'and síkstiin, séventiin, éitiin, náintiin, tuénti tréshur chests!'},
      {en:'A shadow appears and asks for the value of magic:', es:'Aparece una sombra y pregunta el valor de la magia:', pron:'a sháaou apíars and asks for de váliu of máyic:'},
      {en:'How much does a flying castle cost?', es:'¿Cuánto cuesta un castillo volador?', pron:'jáu mach das a fláing cásol cost?'},
      {en:'It is expensive, but that tiny dragon egg is cheap!', es:'Es caro, ¡pero ese huevito de dragón es barato!', pron:'it is ekspénsiv, bat dat táini drágon eg is chíip!'},
      {en:'We check the offers hanging on the stone walls:', es:'Revisamos las ofertas que cuelgan de las paredes de piedra:', pron:'uí chek de ófers jánging on de stóun uóls:'},
      {en:'It costs approximately fifty dollars.', es:'Cuesta aproximadamente cincuenta dólares.', pron:'it costs aprácsimetli fífti dólars.'},
      {en:'It costs a lot.', es:'Cuesta mucho.', pron:'it costs a lot.'},
      {en:'Approximately, the final price is one million stars.', es:'Aproximadamente, el precio final es un millón de estrellas', pron:'aprácsimetli, de fáinal práis is uán mílion stars.'},
      {en:'The deal has been closed in the shadow market...', es:'El trato ha sido cerrado en el mercado de sombras...', pron:'de díil jas bin clóuzd in de sháaou márket...'},
      {en:'See you next week, dragon friend,', es:'Nos vemos la próxima semana, amigo dragón,', pron:'síi iú next uíik, drágon frend,'},
      {en:'Keep practicing until the end.', es:'Sigue practicando hasta el final.', pron:'kíip práctising antíl de end.'},
      {en:'Learning English is easy,', es:'Aprender inglés es fácil,', pron:'lérning ínglish is íisi,'},
      {en:'You\'re going to love it!', es:'¡Te va a encantar!', pron:'iór góing tu lav it!'}
  ...
  },
{
    ...
    songJingle:'cancion-dia26-vocabulario.mp3',
    songStory:'cancion-dia26-historia.mp3',
    songJingleLyrics:[
      {en:'The big warehouse opens its doors', es:'El gran almacén abre sus puertas', pron:'de big uérjaus óupens its dors'},
      {en:'and we must check the time...', es:'y debemos revisar el tiempo...', pron:'and uí mast chek de táim...'},
      {en:'It opens at nine.', es:'Abre a las nueve.', pron:'it óupens at náin.'},
      {en:'It closes at six.', es:'Cierra a las seis.', pron:'it clóuzes at siks.'},
      {en:'It opens at half past eight.', es:'Abre a las ocho y media.', pron:'it óupens at jaf past éit.'},
      {en:'It closes at quarter to five.', es:'Cierra a las cinco menos cuarto.', pron:'it clóuzes at cuárter tu fáiv.'},
      ...
      {en:'Thirty es treinta, forty cuarenta en la cuenta,', es:'Thirty es treinta, forty es cuarenta en la cuenta,', pron:'zérti es treinta, fórti cuarenta en la cuenta,'},
      {en:'Fifty cincuenta, sixty sesenta que aumenta.', es:'Fifty es cincuenta, sixty es sesenta que aumenta.', pron:'fífti cincuenta, síksti sesenta que aumenta.'},
      {en:'Seventy setenta, eighty ochenta verás,', es:'Seventy es setenta, eighty es ochenta verás,', pron:'séventi setenta, éiti ochenta verás,'},
      {en:'Ninety noventa, hundred cien y nada más.', es:'Ninety es noventa, hundred es cien y nada más.', pron:'náinti noventa, jándred cien y nada más.'},
      {en:'Thousand es mil en este gran lugar.', es:'Thousand es mil en este gran lugar.', pron:'záuzand es mil en este gran lugar.'},
      {en:'We ask for a quote,', es:'Pedimos una cotización', pron:'uí ask for a cuóut,'},
      {en:'We calculate the subtotal,', es:'Calculamos el subtotal,', pron:'uí cálkiuleit de sábtoutal,'},
      {en:'the subtotal to pay.', es:'el subtotal a pagar.', pron:'de sábtoutal tu péi.'},
      {en:'the home tax,', es:'el impuesto del hogar,', pron:'de jóum tax,'},
      {en:'and shipping cost,', es:'el costo de envío al sumar.', pron:'and shíping cost,'},
      {en:'Together they grand total,', es:'el total general a llegar,', pron:'tugéder déi grand tóutal,'},
      {en:'we need to add up,', es:'para todo sumar.', pron:'uí níid tu ad ap,'},
      {en:'Learning English is easy,', es:'Aprender inglés es fácil,', pron:'lérning ínglish is íisi,'},
      {en:'You\'re going to love it!', es:'¡Te va a encantar!', pron:'iór góing tu lav it!'},
      {en:'See you next week, dragon friend,', es:'Nos vemos la próxima semana, amigo dragón,', pron:'síi iú next uíik, drágon frend,'},
      {en:'Keep practicing until the end.', es:'Sigue practicando hasta el final.', pron:'kíip práctising antíl de end.'}
    ...
    songStoryLyrics:[
      {en:'We arrive at the market before it closes...', es:'Llegamos al mercado antes de que vaya a cerrar...', pron:'uí aráiv at de márket bifór it clóuzes...'},
      {en:'It opens at nine,', es:'abre a las nueve para empezar.', pron:'it óupens at náin,'},
      {en:'It closes at six,', es:'cierra a las seis al terminar.', pron:'it clóuzes at siks,'},
      {en:'Look around!', es:'¡Mira a tu alrededor en este lugar!', pron:'luk aráund!'},
      {en:'There are thirty dragons, forty wizards, fifty robots, sixty giants,', es:'¡Hay treinta dragones, cuarenta magos, cincuenta robots, sesenta gigantes!', pron:'der ar zérti drágons, fórti uízards, fífti róubats, síksti yáiants,'},
      {en:'seventy fairies, eighty ghosts, ninety aliens,', es:'setenta hadas, ochenta fantasmas, noventa alienígenas,', pron:'séventi féris, éiti góusts, náinti éilians,'},
      {en:'and a hundred talking cats at the market!', es:'¡y cien gatos parlantes en el mercado!', pron:'and a jándred tóking cats at de márket!'},
      {en:'Step by step you win,', es:'paso a paso avanzarás,', pron:'step bái step iú uín,'},
      {en:'Speak it out loud,', es:'¡muy pronto lo hablarás!', pron:'spíik it áut láud,'},
      {en:'A thousand golden coins is our quote for the flying castle.', es:'Mil monedas de oro es nuestra cotización por el castillo volador.', pron:'a záuzand góulden cóins is áur cuóut for de fláing cásol.'},
      {en:'Thirty, forty, fifty,', es:'miles de objetos a comprar,', pron:'zérti, fórti, fífti,'},
      {en:'sixty, seventy, eighty,', es:'noventa y cien hasta el final.', pron:'síksti, séventi, éiti,'},
      {en:'A thousand golden coins,', es:'¡para poder volar!', pron:'a záuzand góulden cóins,'},
      {en:'The subtotal is huge, plus a magic tax,', es:'El subtotal es enorme, más un impuesto mágico,', pron:'de sábtoutal is jiúy, plas a máyic tax,'},
      {en:'plus the shipping cost by dragon.', es:'más el costo de envío en dragón.', pron:'plas de shíping cost bái drágon.'},
      {en:'Let\'s add it all up: the grand total is bigger than the moon!', es:'Sumemos todo: ¡el total general es más grande que la luna!', pron:'lets ad it ol ap: de grand tóutal is bíguer dan de mun!'},
      {en:'Learning English is easy,', es:'Aprender inglés es fácil,', pron:'lérning ínglish is íisi,'},
      {en:'You\'re going to love it!', es:'¡Te va a encantar!', pron:'iór góing tu lav it!'},
      {en:'See you next week, dragon friend,', es:'Nos vemos la próxima semana, amigo dragón,', pron:'síi iú next uíik, drágon frend,'},
      {en:'Keep practicing until the end,', es:'Sigue practicando hasta el final.', pron:'kíip práctising antíl de end,'}
